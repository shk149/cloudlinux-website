...
export default function CTA() {
  ...
  return (
    <section id="contact" ref={ref} className="relative overflow-hidden" style={{ padding: "clamp(3rem, 5vw, 5rem) clamp(1.25rem, 4vw, 3rem)" }}>
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="relative z-10 mx-auto max-w-[640px] text-center">
        ...
        <p className="mx-auto mb-6 max-w-md text-[15px] text-gray-300">
