...
const footerLinks = {
  Products: ["CloudLinux OS", "AccelerateWP", "Imunify360", "ImunifyAV", "KernelCare"],
  Resources: ["Blog", "Case Studies", "Documentation", "Knowledge Base", "Webinars"],
  ...
  return (
    <footer className="border-t border-gray-200 bg-[#F8F9FB]" style={{ padding: "clamp(2.5rem, 5vw, 4rem) clamp(1.25rem, 4vw, 3rem) clamp(1.5rem, 3vw, 2rem)" }}>
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-gray-200 pt-6 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            {[
              ...
              <a key={i} href="#" className="text-[#545769] transition-colors duration-200 hover:text-[#2563EB]" aria-label={["Twitter","LinkedIn","GitHub"][i]}>
        ...
        <div className="mt-3 flex flex-wrap items-center justify-center gap-3 text-[11px] text-[#545769]">
          <a href="#" className="transition-colors hover:text-[#2563EB]">Terms of Use</a>
          <span className="text-gray-300">|</span>
          <a href="#" className="transition-colors hover:text-[#2563EB]">Privacy Policy</a>
          <span className="text-gray-300">|</span>
          <a href="#" className="transition-colors hover:text-[#2563EB]">Cookie Policy</a>
        </div>
      </div>
    </footer>
  );
